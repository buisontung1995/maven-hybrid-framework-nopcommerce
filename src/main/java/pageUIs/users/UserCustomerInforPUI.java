...
public class UserCustomerInforPUI {
	...
	public static final String DOB_DROP_DOWN = "xpath=//select[@name='%s']";
	public static final String SAVE_BUTTON = "xpath=//button[@id='save-info-button']";
	public static final String SUCCESSFUL_NOTIFICATION = "xpath=//p[@class='content']";
}
